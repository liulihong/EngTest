...
export const PAPERLIST = 'PaperList';//试卷列表
export const LOADING = 'loading';//请求发出 正在加载
...
export const GETNEXTSTEPTOPIC = 'getNextStepTopic';//获取下一步题

export const SAVEPLAYTIME = 'savePlayTime';//保存播放时间
