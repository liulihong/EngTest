            ...
            return <View style={{backgroundColor:"#ffffff",marginTop:5}}>
                {
                    this.props.contentData[0].ExampleAnswer.map((element,i) =>{
                        ...
                        return <TextInput
                            ...
                            style={{height:40,width:'100%',fontSize:16,textAlign:'center',backgroundColor:utils.COLORS.theme,marginTop:10}}
                            multiline={false}
                            placeholder={newNum+''}
